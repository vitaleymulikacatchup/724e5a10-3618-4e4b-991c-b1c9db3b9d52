...
export const metadata: Metadata = {
  title: "Bakery Bliss - Artisan Breads & Pastries",
  description: "Discover the delicious range of artisan breads and pastries at Bakery Bliss.",
  keywords: "bakery, artisan, breads, pastries, baking",
  openGraph: {
    title: "Bakery Bliss - Artisan Breads & Pastries",
    description: "Discover the delicious range of artisan breads and pastries at Bakery Bliss.",
    url: "https://www.bakerybliss.com",
    siteName: "Bakery Bliss",
    images: [{ url: "https://images.pexels.com/photos/5377558/pexels-photo-5377558.jpeg?auto=compress&cs=tinysrgb&h=650&w=940", alt: "Warm autumn drink in a yellow mug with pumpkin and squash on a soft background." }],
    type: "website",
  },
  twitter: {
    ...
    title: "Bakery Bliss - Artisan Breads & Pastries",
    description: "Discover the delicious range of artisan breads and pastries at Bakery Bliss.",
    images: ["https://images.pexels.com/photos/5377558/pexels-photo-5377558.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"],
  },
  robots: {
    index: true,
    follow: true,
